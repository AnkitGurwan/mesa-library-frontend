...
const EventsCard = ({title,content}) => {
    ...
    return ( 
        <div ref={ref} className={`relative cursor-pointer transform perspective-1000 transition-transform hover:rotate-y-180 w-full h-full bg-[#ffffff] shadow-light-card rounded-[50px] p-6 md:p-7 flex flex-col items-center ${inView? 'fadeBelowAnimate':''}`}>
