...
const Announcements = () => {
    ...
    return ( 
        <div
            ...
            style={{ fontFamily: 'Manrope', backgroundColor: "#fbfbfd" }}
        >
            <div
                className='text-gray-700 font-extrabold text-4xl py-2 w-full min-w-[270px] max-w-[700px] rounded-sm '
                style={{ fontFamily: "Sans-serif", boxShadow: "rgba(0, 0, 0, 0.25)" }}
            >
                Announcements
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-0 place-items-center'>
                ...
                >
                        ...
                        <button className="my-3 p-1 px-2 rounded-xl text-sm md:text-lg bg-[#1b3358] text-[#efefef]">
                            Class Timetable
                        </button>
                        <p className='text-[#404040] italic font-semibold'>
                            Last updated on Feb 27,2026
                        </p>
                        <p className='text-[#252525] text-sm mt-3 mb-4 '>
                            Find the updated timetable for Jan-May academic session here
                        </p>
                </a>
                ...
                >
                        ...
                        <p className='text-[#252525] mt-3 mb-4 text-sm'>
                            Find the updated Academic Calendar for the year 2026 here
                        </p>
                </a>
