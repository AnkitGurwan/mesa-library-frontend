    ...
    return ( 
        <div className='w-full flex flex-col justify-center items-center text-center text-[#252525]'>
            ...
            <div className='flex flex-col sm:flex-row'>
                    ...
                    <a target='_blank' href='https://www.iitg.ac.in/acad/classtt/ME_TimeTable%20Jan-May%202021_29th%20Dec.pdf'  className='w-[270px] sm:h-[400px] md:w-[300px] my-10 py-2 px-2 sm:mr-8 flex flex-col justify-center items-center text-center border rounded-[5%] shadow-[5px_5px_15px_rgba(0,0,0,0.25)]'>
                ...
                <a target='_blank' href='https://iitg.ac.in/acad/Exam/END-SEMESTER_AND_MID-SEMESTER_EXAM_SCHEDULE.pdf' className='w-[270px] sm:h-[400px] md:w-[300px] my-10 py-2 px-2 sm:ml-8 flex flex-col justify-center items-center text-center border rounded-[5%] shadow-[5px_5px_15px_rgba(0,0,0,0.25)]'>
