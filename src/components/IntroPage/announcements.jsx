...
const Announcements = () => {
    ...
    return ( 
        <div className='w-full my-[87px] flex flex-col justify-center items-center text-center text-[#252525]'>
            <div className='text-white font-extrabold text-3xl bg-slate-400 py-2 w-full min-w-[270px] max-w-[700px] rounded-sm tracking-wider' style={{"font-family": "Dancing Script,cursive"}}>Announcements</div>
