                ...
                <div>
                    ...
                    <div className="hidden sm:flex">
                        {navbarPages.map(([title, url]) => (
                            <NavLink to={url} className="rounded-lg px-1 py-2 text-slate-700 font-semibold text-lg lg:text-[20px] ml:5 last:mr-10 lg:ml-10 lg:last:mr-20 hover:bg-slate-100 hover:text-slate-900">{title}</NavLink>
                        ))}
                    </div>
                </div>
            </div>
