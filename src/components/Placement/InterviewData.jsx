          ...
          <div className="bg-white shadow-[0_4px_10px_rgba(0,0,0,0.25)] rounded-lg p-6 sm:p-8">
            ...
            <div className="flex justify-center gap-4 mb-6">
              <button
                ...
                className="px-10 py-2 text-lg bg-green-700 text-white font-semibold rounded-lg hover:bg-green-900 transition duration-200"
              >
                Filter
              </button>
              <button
                onClick={() => setSearch("")}
                className="px-10 py-2 text-lg bg-red-600 text-white font-semibold rounded-lg hover:bg-red-800 transition duration-200"
              >
                Reset
              </button>
            </div>
                    ...
                    {filteredData.map((info, index) => (
                      <tr
                        ...
                        className={`${index % 2 === 0 ? "bg-blue-50" : "bg-gray-50"
                          } cursor-pointer hover:bg-slate-300 transition duration-200 ease-in-out`}
                        onClick={() => goToDetails(info)}
                      >
                        <td className="px-4 py-3 border border-gray-300 break-words">
